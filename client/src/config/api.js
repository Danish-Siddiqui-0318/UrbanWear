export const API_BASE_URL = import.meta.env.VITE_API_URL || "https://urbanwear-production.up.railway.app";
export const WHATSAPP_NUMBER = (import.meta.env.VITE_WHATSAPP_NUMBER || "03082251508").trim();
